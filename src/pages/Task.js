...
const TABLE_HEAD = [
  { id: 'task_title', label: 'TASK TITLE', alignRight: false },
  { id: 'task_description', label: 'TASK DESCRIPTION', alignRight: false },
  { id: 'project_manager', label: 'PROJECT MANAGER', alignRight: false },
  { id: 'project_title', label: 'PROJECT TITLE', alignRight: false },
...
function applySortFilter(array, comparator, query) {
  ...
  if (query) {
    return filter(array, (_user) => _user.task_title.toLowerCase().indexOf(query.toLowerCase()) !== -1);
  }
...
export default function Task() {
  ...
  // const [open, setAction]{open:false,type:"",data:null}eState(false);
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelecteds = tasks.map((n) => n.task_title);
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    ...
                    const isItemSelected = selected.indexOf(task_title) !== -1;
                    ...
                    return (
                      ...
                      >
                        <TableCell padding="checkbox">
                          <Checkbox checked={isItemSelected} onChange={(event) => handleClick(event, task_title)} />
                        </TableCell>
                        ...
                        <TableCell align="left">{task_description}</TableCell>
                        <TableCell align="left">{project_manager}</TableCell>
