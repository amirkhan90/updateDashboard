...
const TABLE_HEAD = [
  ...
  { id: 'site_address', label: 'SITE ADDRESS', alignRight: false },
  { id: 'site_contact', label: 'CONTACT NUMBER', alignRight: false },
  { id: '' },
];
      ...
      <Container>
        ...
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          ...
          <Button
            ...
            onClick={() => setAction({ open: true, type: 'add projects', data: null })}
          >
            New Project
          </Button>
        </Stack>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { id, title, description, site_address, site_contact } = row;
